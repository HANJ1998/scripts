...
// @version      1.2.1
// @updateURL    https://jsd.onmicrosoft.cn/gh/HANJ1998/scripts@v1.2.1/CSDN一键三连.js
// @downloadURL  https://jsd.onmicrosoft.cn/gh/HANJ1998/scripts@v1.2.1/CSDN一键三连.js
...
(function () {
  ...
  function clickBtn() {
    setTimeout(function () {
      ...
      setTimeout(function () {
        document.getElementsByClassName("csdn-collection-submit")[0].click();
      }, 1000); // 延时500ms点击收藏按钮
