...
// @updateURL    https://jsd.onmicrosoft.cn/gh/HANJ1998/scripts@v1.3.2/网页表格导出.js
// @downloadURL  https://jsd.onmicrosoft.cn/gh/HANJ1998/scripts@v1.3.2/网页表格导出.js
// @license      MIT
...
(function () {
  ...
  function showExcludeDialog(currentSites) {
    ...
    dialog.style.cssText =
      "position:fixed;top:0;left:0;width:100%;height:100%;background:rgba(0,0,0,0.5);z-index:10000;display:flex;justify-content:center;align-items:center;";

    const content = document.createElement("div");
    content.style.cssText =
      "background:white;padding:20px;border-radius:8px;max-width:600px;width:90%;box-shadow:0 4px 20px rgba(0,0,0,0.3);";
    ...
    textarea.style.cssText =
      "width:100%;height:200px;padding:10px;border:1px solid #ddd;border-radius:4px;font-family:monospace;font-size:12px;resize:vertical;box-sizing:border-box;color:#333;background-color:#fff;";
    ...
    cancelButton.style.cssText =
      "padding:8px 20px;border:1px solid #ccc;background:#f5f5f5;color:#333;border-radius:4px;cursor:pointer;transition:all 0.2s;";
    ...
    saveButton.style.cssText =
      "padding:8px 20px;border:none;background:#227447;color:white;border-radius:4px;cursor:pointer;transition:all 0.2s;";
    ...
    authorAndVersionInfo.textContent =
      "版本：" + version + " | " + "作者：" + author;
    authorAndVersionInfo.style.cssText =
      "color:#227447;font-size:12px;margin-right:auto;";
  ...
  function exportTableToXLSX(table) {
    ...
    try {
      ...
      let tableTitle = "";
      // 查找表格附近的标题元素
      const possibleTitles = table.parentNode.querySelectorAll(
        "h1, h2, h3, h4, h5, h6",
      );
